...
<div class="prl-grid prl-grid-divider">
	<section id="main" class="prl-span-9">
		<table>
            <?php if(count($artist_category) > 0){
                foreach($artist_category as $cat){ ?>
                    <tr>
                        <td>
                            <a href="<?php echo site_url() ?>/index/artist_listing/<?php echo $cat->id ?>"><?php echo $cat->artist_category_name ?></a>
                        </td>
                    </tr>
                <?php } } ?>
                    </table>
