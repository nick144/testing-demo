...
<div class="prl-grid prl-grid-divider">
	<section id="main" class="prl-span-9">
		<table>
            <?php if(count($movie_category) > 0){
                foreach($movie_category as $cat){ ?>
                    <tr>
                        <td>
                            <a href="<?php echo site_url() ?>/index/movie_listing/<?php echo $cat->id ?>"><?php echo $cat->movie_category_name ?></a>
                        </td>
                    </tr>
                <?php } } ?>
                    </table>
